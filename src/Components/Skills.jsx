  ...
  const skillGroups = [
    {
      ...
      detail:
        "MongoDB, Express, React, Node.js with scalable app architecture.",
    },
    {
      title: "Frontend Engineering",
      icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg",
      detail:
        "JavaScript, Tailwind CSS, responsive UI systems, and component design.",
    },
    {
      title: "Backend & APIs",
      icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-original.svg",
      detail:
        "Express.js, REST APIs, authentication, middleware, and server logic.",
    },
    {
      title: "Databases",
    ...
    },
    {
      ...
      detail:
        "Git and GitHub workflows for collaboration, reviews, and releases.",
    },
  ];
    ...
    <section className="page-shell">
      <div className="mb-8 text-center">
        ...
        <p className="section-lead mt-2 max-w-2xl mx-auto">
          Focused on end-to-end application development with practical
          engineering and consistent delivery.
        </p>
      </div>
