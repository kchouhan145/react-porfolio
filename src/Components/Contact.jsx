...
const Contact = () => {
  return (
    <div className="min-h-[95vh] w-[90vw] max-w-6xl mx-auto rounded-xl m-3 shadow-xl bg-white flex flex-col items-center justify-center p-8">
      ...
      <div className="flex flex-col items-center gap-4 mb-8">
        <div className="flex items-center gap-2">
          ...
          <a href="mailto:k1452003@gmail.com" className="text-blue-600 hover:underline">
            k1452003@gmail.com
          </a>
        </div>
        <div className="flex items-center gap-2">
          <span className="font-semibold text-gray-700">Mobile:</span>
          <a href="tel:+919997694610" className="text-blue-600 hover:underline">
            +91 9997694610
          </a>
        </div>
      </div>
      <div className="flex gap-6">
        <a href="https://github.com/kchouhan145" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
          <svg className="w-7 h-7 text-gray-700 hover:text-black" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a href="https://www.instagram.com/kchouhan.14" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
          <svg className="w-7 h-7 text-pink-500 hover:text-pink-700" fill="currentColor" viewBox="0 0 24 24">
